    ...
    <div className="relative flex h-8 w-8 shrink-0 items-center justify-center">
      <svg width="32" height="32" viewBox="0 0 32 32" className="-rotate-90">
        ...
        <circle
          ...
          style={{ "--line-length": filled } as CSSProperties}
        />
      </svg>
...
export function SignalCard({ signal, priority }: { signal: EventSignal; priority?: boolean }) {
  ...
  return (
    <div className={`card-lift flex flex-col gap-3 rounded-xl border bg-surface p-4 transition-colors hover:bg-surface-2 ${
      priority ? "border-accent/25 shadow-[0_0_0_1px_rgba(74,222,128,0.06)] animate-border-shimmer" : "border-border hover:border-border/80"
    }`}>
      {/* Header */}
