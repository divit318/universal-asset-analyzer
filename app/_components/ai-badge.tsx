 ...
 * hand-written pill: given the model id that actually produced the output it
 * says "Claude · claude-opus-5-high", and "AI" when the model is unknown. The
 * tooltip states exactly where the generation ran and what left the machine —
 * see lib/ai/availability.ts for why a static "local" label is not allowed to
 * exist anymore.
 */
