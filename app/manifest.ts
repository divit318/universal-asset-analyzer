...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    short_name: "UAA",
    description:
      "Institutional-grade equity research: AI-powered deep research, DCF modelling, quant screening and portfolio management — running entirely on your own machine.",
    start_url: "/",
    display: "standalone",
