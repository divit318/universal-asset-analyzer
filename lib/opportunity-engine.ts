...
function deriveConviction(score: number, confidence: number): Conviction {
  // CALIBRATION NOTE (2026-08-02, hosted-model switch): the hosted models'
  // confidence scores run ~28 points LOWER than the old local-model numbers
  // on identical inputs because they are better calibrated, not worse
  // (measured across 15 symbols: local mean 62.7 vs hosted 34.9 —
